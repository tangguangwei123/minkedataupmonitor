module.exports =   {
    appenders: {
        file: {
            type : 'file',
            filename: __dirname + '/logs/log_file.log',//文件目录，当目录文件或文件夹不存在时，会自动创建
        ...
        'just-errors': { type: 'file', filename: __dirname +'/logs/error.log' },
    ...
    categories: {
        default: { appenders: ['file', 'dateFile', 'out','error'], level: 'trace' }
    }
}